...
public class SegmentRepositoryAdapter implements SegmentRepository {
    ...
    public void save(Segment segment) {
        ...
        if (segmentJpaRepository.existsByLineJpaEntity_IdAndBeforeStationJpaEntity_IdAndAfterStationJpaEntity_Id(
                lineId, beforeId, afterId
        )) {
            throw CustomException.domain(DomainErrorCode.SEGMENT_ALREADY_EXISTS)
